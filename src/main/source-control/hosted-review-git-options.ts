...
export type HostedReviewExecutionOptions = {
  ...
  /** Paths TeamRun may have symlinked into this worktree. An untracked entry that
   *  is one of these is TeamRun's own artifact, not work the user can commit, so it
