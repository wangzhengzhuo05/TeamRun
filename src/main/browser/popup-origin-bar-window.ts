...
/**
 * Hosts a guest-opened popup inside an TeamRun-built window whose top strip is a
 * separate, TeamRun-controlled WebContentsView showing the popup's current
...
export function openPopupWithOriginBar(
  ...
  // Why: the origin bar renders only TeamRun's own data: URL and must stay
