...
export type GetStatusOptions = GitRuntimeOptions & {
  ...
  /** Paths TeamRun may have symlinked into this worktree (per-user shared paths
   ...
   *  repo's rule is directory-only (`node_modules/`), but they are TeamRun's own
...
/** Remove untracked entries that are shared symlinks TeamRun created.
 *
