    ...
    case 'update-available':
      return {
        ...
        description: translate(
          ...
          'The file contains configuration keys that this version of TeamRun does not recognize. You may need to update TeamRun, or check the file for typos.'
        )
      }
    case 'invalid':
      return {
        ...
        description: translate(
          ...
          'The core configuration file exists in the repo root, but TeamRun could not parse the supported hook definitions yet.'
        )
      }
    default:
      return {
          ...
          <p className="text-xs leading-5 text-muted-foreground">
            {isChecking
              ? translate(
                  ...
                  'Local scripts are saved. TeamRun is still checking orca.yaml before it can recommend which script source to use.'
                )
              : translate(
                    ...
                    <div className="space-y-2 text-xs text-muted-foreground">
                      <p>
                        {translate(
                          ...
                          'The file is present, but TeamRun could not find valid `scripts` or `issueCommand` definitions.'
                        )}
                      </p>
