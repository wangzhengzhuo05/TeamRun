...
export function ArtifactsSettingsPane({
  ...
  const howToSteps: HowToStep[] = [
      ...
      : [
          {
            ...
            description: isWebClient
              ? translate(
                  ...
                  'Open Settings → Artifacts in the TeamRun desktop app on the host device and enable publishing.'
                )
              : translate(
    ...
    {
      key: 'manage',
      title: translate('auto.components.settings.artifacts.manageStepTitle', 'Manage it in TeamRun'),
      description: translate(
          ...
          >
            {connecting
              ...
              : authStatus?.state === 'reconnect-required'
                ...
                : translate('auto.components.settings.artifacts.signIn', 'Sign in to TeamRun')}
          </Button>
        </section>
      ) : null}
