...
export const getGeneralCliSearchEntries = createLocalizedCatalog(() => [
  {
    title: translate('auto.components.settings.general.search.327e3fa70d', 'TeamRun CLI'),
    description: translate(
      'auto.components.settings.general.search.ca529079bf',
      'Register or remove the TeamRun CLI command.'
    ),
    keywords: [
  ...
  },
  {
    ...
    description: translate(
      ...
      'Install the TeamRun skill so agents know to use the TeamRun CLI.'
    ),
    keywords: [
...
export const getGeneralUpdateSearchEntries = createLocalizedCatalog(() => [
  {
    ...
    description: translate(
      ...
      'Check for app updates and install a newer TeamRun version.'
    ),
    keywords: [
