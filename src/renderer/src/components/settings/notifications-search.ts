...
export const getNotificationsPaneSearchEntries = createLocalizedCatalog(() => [
  {
    ...
    description: translate(
      ...
      'Master switch for TeamRun desktop notifications.'
    ),
    keywords: [
  ...
  },
  {
    ...
    description: translate(
      ...
      'Avoid notifying when TeamRun is focused on the active worktree.'
    ),
    keywords: [
      ...translateSearchKeyword(
        'auto.components.settings.notifications.search.ca8faa40d7',
  ...
  },
  {
    ...
    description: translate(
      ...
      'Choose the built-in, system, or local audio file TeamRun plays for desktop notifications.'
    ),
    keywords: [
      ...translateSearchKeyword(
        'auto.components.settings.notifications.search.ca8faa40d7',
