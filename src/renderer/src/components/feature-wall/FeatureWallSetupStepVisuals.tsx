...
// Mac-style terminal traffic-light dots — the signature of an TeamRun terminal pane.
...
// Use TeamRun's browser: a browser pane with a cursor grabbing one highlighted
