...
// Why: this animation tells the full TeamRun story end-to-end — the user opens a
...
// TeamRun's dropdown/popover primitives while staying inside the storyboard DOM.
