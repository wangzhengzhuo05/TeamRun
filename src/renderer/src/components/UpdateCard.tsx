      ...
      ? isLocalBuild
        ...
        : isHttp2UpdateError
          ? {
              ...
              summary: 'TeamRun can retry through HTTP/1.1 compatibility mode.',
              explainer: translate(
          ...
          : isSignatureMismatchError
            ? {
                ...
                summary: translate(
                  ...
                  "The installer's publisher doesn't match TeamRun, so we stopped the update. Don't install this download; check official releases for a corrected version."
                ),
                detail: status.message,
            ...
            : isSignatureCheckBlockedError
              ...
              : {
                  // Why: title is scoped to the failed operation so check-time (GitHub-side) failures don't read as an TeamRun bug.
...
function SimpleCardContent({
  ...
  return (
    <div className="flex flex-col gap-2.5 p-3.5">
      ...
      <p className="text-sm text-muted-foreground">
        {translate('auto.components.UpdateCard.05ad78a6d1', 'TeamRun v{{value0}} is ready.', {
          value0: version
        })}
      </p>
  ...
  return (
    <div className="flex flex-col gap-3 p-4">
      ...
      <p className="text-sm text-muted-foreground">
        {release
          ? release.description
          : translate('auto.components.UpdateCard.93794ea932', 'TeamRun v{{value0}} is downloading.', {
              value0: version
            })}
      </p>
    ...
    <div className="flex flex-col gap-3 p-4">
      ...
      <p className="text-sm text-muted-foreground">
        {translate(
          ...
          "TeamRun v{{value0}} is downloaded. Restart when you're ready.",
          { value0: version }
        )}
      </p>
