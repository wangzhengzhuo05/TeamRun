...
/**
 * Persistent "star TeamRun on GitHub" notification card.
 *
        ...
        <div className="flex flex-col gap-2.5 p-3.5">
          <div className="flex items-start justify-between gap-2">
            <div className="flex items-center gap-2">
              ...
              <h3 id="star-nag-heading" className="text-sm font-semibold">
                {translate('auto.components.StarNagCard.5f6df21046', 'Enjoying TeamRun?')}
              </h3>
            </div>
            <Button
              variant="ghost"
          ...
          <p className="text-sm text-muted-foreground">
            {translate(
              ...
              'TeamRun is open source. If it helped today, a GitHub star helps other developers find it.'
            )}
          </p>
