...
const CLI_AGENT_COMMANDS = [
  'teamrun worktree create --name auth-pr-1',
  'teamrun worktree create --name auth-pr-2',
  'teamrun orchestration dispatch --task pr1 --to w1',
  'teamrun orchestration dispatch --task pr2 --to w2'
]
