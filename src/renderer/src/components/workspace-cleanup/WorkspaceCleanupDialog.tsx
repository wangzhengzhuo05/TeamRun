  ...
  const estimateMismatchNotice =
    ...
    filteredCandidates.length === candidates.length
      ? translate(
          ...
          "Resource Manager counts {{value0}}; this list found {{value1}}. That counter reads TeamRun's activity record alone, while this scan also checks each workspace's git history and skips disconnected remotes.",
