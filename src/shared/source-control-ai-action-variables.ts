...
export const SOURCE_CONTROL_ACTION_VARIABLE_INFO = {
  basePrompt: {
    description:
      'TeamRun’s built-in prompt for this action, including the context TeamRun knows how to gather safely.',
    example:
  ...
  firstPrompt: {
    description: 'The first user request that created the TeamRun workspace.',
    example: 'Fix CI and commit the result'
  },
  assistantMessage: {
    description: 'The initial agent response, when TeamRun has one available.',
