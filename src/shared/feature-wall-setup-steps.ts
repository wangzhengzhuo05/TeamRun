...
export const FEATURE_WALL_SETUP_STEPS: readonly FeatureWallSetupStep[] = [
  ...
  {
    id: 'browser',
    name: "Use TeamRun's browser",
    subtitle: "Use TeamRun's browser",
    description:
      'Browse your web app without leaving TeamRun. Grab any element and send its exact source and styles to an agent with one click.'
  },
  {
    id: 'notifications',
  ...
  },
  {
    ...
    name: 'Enable TeamRun CLI',
    subtitle: 'Enable TeamRun CLI',
    description:
      'Register the TeamRun shell command and install agent skills for browser, computer, and orchestration workflows.'
  },
  {
    id: 'task-sources',
  ...
  },
  {
    ...
    description:
      'Bring your key repos into TeamRun so you can start agent work without hunting for folders.'
  }
] as const
