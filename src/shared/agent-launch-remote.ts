/**
 * Why: a repo reached over SSH runs the TeamRun CLI through the relay shim, which
 ...
 * GNOME TeamRun screen reader on a local desktop — must not be applied to those
