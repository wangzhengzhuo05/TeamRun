...
export const TEAMRUN_CLOUD_RUNTIME_CAPABILITY = 'teamrun.cloud.v1' as const
export const TEAMRUN_TEAM_SERVER_RUNTIME_CAPABILITY = 'teamrun.team-server.v1' as const
