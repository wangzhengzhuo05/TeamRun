/**
 * Builds the exact bytes TeamRun writes into an interactive shell to deliver and
...
export type StartupCommandSubmissionOptions = {
  ...
  submit: string
  /** Whether the target line editor has bracketed-paste mode active (TeamRun's
