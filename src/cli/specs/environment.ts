...
export const ENVIRONMENT_COMMAND_SPECS: CommandSpec[] = [
  {
    ...
    summary: 'Save a remote TeamRun runtime environment from a pairing code',
  ...
  },
  {
    ...
    summary: 'List saved TeamRun runtime environments',
    usage: 'orca environment list [--json]',
    allowedFlags: [...GLOBAL_FLAGS]
  },
  {
    path: ['environment', 'show'],
    summary: 'Show one saved TeamRun runtime environment',
  ...
  },
  {
    path: ['environment', 'rm'],
    destructive: true,
    summary: 'Remove one saved TeamRun runtime environment',
