...
export const AGENT_HOOK_COMMAND_SPECS: CommandSpec[] = [
  {
    ...
    summary: 'Repair TeamRun-managed Codex hook trust before a shell launch',
    usage: 'orca agent hooks prepare-codex',
    allowedFlags: [...GLOBAL_FLAGS]
  },
  {
    path: ['agent', 'hooks', 'status'],
    summary: 'Show whether TeamRun-managed agent status hooks are enabled',
  ...
  },
  {
    ...
    summary: 'Disable TeamRun-managed agent status hooks and remove local hook entries',
  ...
  {
    path: ['agent', 'hooks', 'on'],
    summary: 'Enable TeamRun-managed agent status hooks',
