...
export const AUTOMATION_COMMAND_SPECS: CommandSpec[] = [
  {
    ...
    summary: 'List scheduled TeamRun automations',
  ...
  },
  {
    ...
    summary: 'Show one TeamRun automation',
  ...
  },
  {
    ...
    summary: 'Create a scheduled TeamRun automation',
    usage:
    ...
    notes: [
      ...
      'When --repo is omitted, the CLI uses the enclosing TeamRun worktree when one can be resolved from cwd.',
  ...
  },
  {
    ...
    summary: 'Edit an TeamRun automation',
  ...
  },
  {
    ...
    destructive: true,
    summary: 'Remove an TeamRun automation and its run history',
  ...
  },
  {
    ...
    summary: 'Run an TeamRun automation now',
