...
// round-trip, even when TeamRun is healthy. Give browser.wait an explicit timeout
// budget so slow waits do not get mislabeled as "TeamRun is not running" by the
