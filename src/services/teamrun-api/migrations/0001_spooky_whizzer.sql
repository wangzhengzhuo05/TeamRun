...
CREATE UNIQUE INDEX "organization_invitations_pending_email" ON "organization_invitations" USING btree ("organization_id","email") WHERE "organization_invitations"."status" = 'pending';