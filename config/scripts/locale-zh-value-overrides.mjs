...
export const ZH_VALUE_OVERRIDES = {
  ...
  'TeamRun IDE': 'TeamRun IDE',
  'TeamRun first': 'TeamRun 优先',
  'TeamRun Mobile': 'TeamRun Mobile',
  'TeamRun logo': 'TeamRun 标志',
  'Enjoying TeamRun?': '喜欢 TeamRun 吗？',
  'Get to know TeamRun': '了解 TeamRun',
  'Expand TeamRun': '展开 TeamRun',
  'Support TeamRun': '支持 TeamRun',
  'Restarting TeamRun…': '正在重启 TeamRun…',
  'Show TeamRun Mobile Button': '显示 TeamRun Mobile 按钮',
  ...
  "Give agents direct access to TeamRun's browser so they can test pages, capture screenshots, and act on what they see.":
    '让代理直接访问 TeamRun 的浏览器，以便测试页面、捕获屏幕截图并根据所见内容执行操作。',
  ...
  'from TeamRun. It is still on your disk.': '来自 TeamRun。它仍保留在您的磁盘上。',
