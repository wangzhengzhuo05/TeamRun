...
export const LOCALE_VALUE_OVERRIDES = {
  es: {
    'Explore TeamRun': 'Explorar TeamRun',
  ...
  ko: {
    ...
    'Connect to TeamRun': 'TeamRun에 연결',
    'USB Devices': 'USB 장치',
  ...
  zh: {
    ...
    'Connect to TeamRun': '连接到 TeamRun',
    'USB Devices': 'USB 设备',
  ...
  ja: {
    ...
    'Connect to TeamRun': 'TeamRun に接続',
    ...
    'Kill all': 'すべて強制終了',
    'kill all': 'すべて終了',
    'Collapse TeamRun': 'TeamRun を折りたたむ',
