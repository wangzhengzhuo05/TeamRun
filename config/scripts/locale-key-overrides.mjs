...
const BASE_LOCALE_KEY_OVERRIDES = {
  ...
  'menu.showMobileButton': {
    ko: 'TeamRun 모바일 버튼 표시',
    zh: '显示 TeamRun Mobile 按钮',
    ja: 'TeamRun Mobile ボタンを表示'
  },
  ...
  'menu.exploreOrca': { ko: 'TeamRun 둘러보기', zh: '探索 TeamRun', ja: 'TeamRun を探索' },
  ...
  // Onboarding pill beside TeamRun Mobile: "New" marks a new feature, not a create action.
