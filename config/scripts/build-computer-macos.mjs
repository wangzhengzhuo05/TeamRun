...
const appPath = path.join(packagePath, '.build', 'release', 'TeamRun Computer Use.app')
...
const displayName = 'TeamRun Computer Use'
...
<dict>
  ...
  <string>TeamRun Computer Use needs Accessibility permission to read and interact with app interfaces when you ask TeamRun to use apps.</string>
  <key>NSScreenCaptureUsageDescription</key>
  <string>TeamRun Computer Use needs Screen Recording permission to capture app windows when you ask TeamRun to inspect your screen.</string>
</dict>
</plist>
`
}
