...
export const LOCALE_PHRASE_FIXES = {
  ...
  zh: [
    ...
    { pattern: /连接到TeamRun/g, replacement: '连接到 TeamRun', whenEnIncludes: 'Connect to TeamRun' },
    {
      pattern: /开始使用TeamRun/g,
      replacement: '开始使用 TeamRun',
      whenEnIncludes: 'get started with TeamRun'
    },
