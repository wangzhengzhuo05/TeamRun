...
<p align="center">
  ...
  <a href="https://discord.gg/fzjDKHxv8Q"><img src="https://img.shields.io/badge/Discord-5865F2?logo=discord&logoColor=white" alt="Únete al Discord de TeamRun" /></a>
  <a href="https://x.com/orca_build"><img src="https://img.shields.io/badge/X-000000?logo=x&logoColor=white" alt="Sigue a TeamRun en X" /></a>
...
<h3 align="center"><a href="https://onorca.dev/download"><ins>Descargar TeamRun</ins></a></h3>

<p align="center">
  <img src="../assets/readme-hero.jpg" alt="La app de escritorio de TeamRun ejecutando agentes en worktrees paralelos, con la app companion móvil de TeamRun en la esquina" width="960" />
</p>
...
<td width="50%">
  <a href="https://www.onorca.dev/docs/mobile"><picture><source srcset="../assets/feature-wall/mobile-companion-app-showcase.gif" type="image/gif"><img src="../assets/feature-wall/mobile-companion-app-showcase.jpg" alt="TeamRun de escritorio con la app companion móvil" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
<td width="50%">
  <a href="https://www.onorca.dev/docs/review/linear"><picture><source srcset="../assets/feature-wall/github-linear.gif" type="image/gif"><img src="../assets/feature-wall/github-linear.jpg" alt="Flujos de trabajo de GitHub y Linear en TeamRun" width="100%" /></picture></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
Deja comentarios en cualquier línea de un diff y envíalos de vuelta al agente — revisa, edita y haz commit sin salir de TeamRun.
...
Los agentes también manejan TeamRun — automatiza cualquier flujo de trabajo con `orca worktree create`, `snapshot`, `click` y `fill`.

[Docs →](https://www.onorca.dev/docs/cli/overview)

</td>
<td width="50%">
  <a href="https://www.onorca.dev/docs/cli/overview"><picture><source srcset="../assets/feature-wall/orca-cli.gif" type="image/gif"><img src="../assets/feature-wall/orca-cli.jpg" alt="Automatiza TeamRun desde la CLI" width="100%" /></picture></a>
</td>
</tr>
</table>
...
Funciona con **cualquier agente CLI** — si corre en una terminal, corre en TeamRun.
...
- **Privacidad:** Consulta la [documentación de privacidad y telemetría](https://www.onorca.dev/docs/telemetry) para saber qué datos anónimos de uso recopila TeamRun y cómo desactivar su envío.
...
¿Quieres contribuir o ejecutar TeamRun localmente? Consulta nuestra guía [CONTRIBUTING.md](../../.github/CONTRIBUTING.md).

<a href="https://github.com/stablyai/orca/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=stablyai/orca" alt="Contribuidores de TeamRun" />
</a>

## Licencia

TeamRun es libre y de código abierto bajo la [Licencia MIT](../../LICENSE).
