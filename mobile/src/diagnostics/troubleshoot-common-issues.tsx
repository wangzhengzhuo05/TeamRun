...
export const troubleshootCommonIssues: TroubleshootSection[] = [
  ...
  },
  {
    ...
    steps: [
      'macOS: System Settings → Network → Firewall — allow TeamRun.',
      'Windows: Defender Firewall → Allow app — enable TeamRun for Private networks.',
  ...
  },
  {
    ...
    steps: [
      'TeamRun must be open on your desktop to accept connections.',
      'Try restarting TeamRun — the companion server starts on launch.',
